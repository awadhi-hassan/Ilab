...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start(); // // Generating Access token
...
document.getElementById('stkpush').addEventListener('click', function (event) {
  event.preventDefault();
  var requestBody = {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default().post('stkpush', requestBody).then(function (response) {
    if (response.data.ResponseDescription) {
