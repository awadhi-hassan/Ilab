<x-app-layout>
    <section class="header">
        <div class="text-box">
            ...
            <a href="Wifi internet.html"class="hero"><span></span>Internet & WiFi Solutions</a>
            <a href="cctv systems.html"class="hero"><span></span>CCTV & Access Control Systems</a>
        </div>
    </section>
    <!----course-------->
    ...
    <section class="campus">
        ...
        <div class="row">
            ...
            <div class="campus-col">
                <img src="images/camera1.jpeg">
            </div>
            <div class="campus-col">
                <img src="images/camera2.jpeg">
            </div>
        </div>
